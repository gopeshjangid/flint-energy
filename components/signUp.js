  ...
  return (
    <Container component="main" maxWidth="xs">
      ...
      <div className={classes.paper}>
        ...
        <Typography component="h1" variant="h5">
        <div style={{fontSize:'15px'}} dangerouslySetInnerHTML={{__html: msg}}></div>
        </Typography>
          ...
          <Grid container spacing={2}>
            ...
            <input
                       style={{display: 'none'}}
                        ...
                        onChange={onFileUpload} name="upload"
                        type="file"
                        />
                        <label htmlFor="contained-button-file">
                        <Button  size="medium" fullWidth={true} color="secondary" variant="outlined" component="div">
                             Upload Cover Image
                        </Button>
                        </label>
                       <div style={{display :'inline-block' ,marginTop : '5px'}}>{state.profile_pic && <Avatar alt="profilePic" src={state.profile_pic}  />}</div>
            </Grid>
            <Grid item xs={12}>
             { /* <FormControlLabel
